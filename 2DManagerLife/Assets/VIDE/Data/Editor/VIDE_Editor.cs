...
public class VIDE_Editor : EditorWindow
{
    ...
    void DrawNodeWindow(int id)
    {
        ...
        stf.wordWrap = true;
        stf.normal.textColor = (Application.HasProLicense()) ? Color.black : Color.white;
        stf.focused.textColor = (Application.HasProLicense()) ? Color.black : Color.white;
        stf.active.textColor = (Application.HasProLicense()) ? Color.black : Color.white;
        Color last = GUI.backgroundColor;
        GUIStyle exD = new GUIStyle(EditorStyles.textArea);
        exD.normal.textColor = (Application.HasProLicense()) ? Color.black : Color.white;
        exD.active.textColor = (Application.HasProLicense()) ? Color.black : Color.white;
        exD.focused.textColor = (Application.HasProLicense()) ? Color.black : Color.white;
        exD.wordWrap = false;
